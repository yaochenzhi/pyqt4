...
class Window(QtGui.QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowIcon(QtGui.QIcon(os.path.join(BASE_DIR,'python.png')))
    ...
    def home(self):
        ...
        extractAction = QtGui.QAction(QtGui.QIcon(os.path.join(BASE_DIR,'icon.png')), 'Flee the Scence', self)
        extractAction.triggered.connect(self.close_application)
